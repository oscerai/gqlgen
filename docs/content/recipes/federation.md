...
server in gqlgen. You can find the finished result in the [examples directory](https://github.com/oscerai/gqlgen/tree/master/_examples/federation).
...
```bash
go run github.com/oscerai/gqlgen
```
